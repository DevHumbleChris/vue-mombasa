...
const joinEmailList = () => {
    if (!email.value) {
        return toast('Email is required! Please provide one.', {
            type: 'warning',
            theme: 'colored'
        })
    } 
    if(!emailValidator.validate(email.value)){
         return toast('Invalid email address! Please check.', {
            type: 'warning',
            theme: 'colored'
        })
    }
...
<template>
  <section
    class="grid md:grid-cols-2 gap-4 my-6 sm:my-8 md:my-12 items-center mx-4"
  >
    <div>
      <ConstructionSVG />
    </div>
    <div class="text-center">
      ...
      <div class="my-6">
        ...
        <a
          href="https://chat.whatsapp.com/CtNmD8cpogJLvzkh0AonO8"
          class="
            flex
            space-x-3
            items-center
